...
const uk = [
  ...
  {
    art: 'ст. 212 УК — массовые беспорядки, призывы к незаконным массовым мероприятиям',
    must: ['давайте устроим массовые беспорядки', 'призываю к перевороту', 'свергнем власть и захватим всё', 'организуем бунт', 'выйдем на улицы и перекроем дороги'],
    label: 'unrest',
  },
  {
    art: 'ФЗ-41/ст. 6.21 КоАП — пропаганда нетрадиционных сексуальных отношений (ЛГБТ)',
    must: ['пропаганда лгбт приветствуется', 'я пропагандирую гомосексуализм', 'агитирую за лгбт, вступайте', 'пропаганда нетрадиционных сексуальных отношений это здорово'],
    label: 'lgbt_propaganda',
  },
  {
    art: 'ФЗ-15 — запрет дистанционной продажи/рекламы табака',
    must: ['продаю сигареты оптом', 'вейп в наличии заказать можно', 'продаю снюс и табак'],
    label: 'tobacco',
  },
];
